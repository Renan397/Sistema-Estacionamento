    ...
    <div class="container" id="formularios">
        <div class="row">
            <div class="col-6" id="entrada_veiculos">
                ...
                <form id="form_entrada" method="POST" action="Source/database/inserirAgenda.class.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="hora_entrada_cli" required="required" min="08:00" max="21:00" class="form-control" id="exampleFormControlInput1">
                    </div>
            ...
            <div class="col-6" id="saida_veiculos">
                ...
                <form id="form_saida" method="POST" action="Source/database/atualizarAgenda.class.php">
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Placa do veículo</label>
